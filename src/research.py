        ...
        "facts": [
            {
                ...
                "source_name": "宮内庁報道発表（2001年12月1日）",
                "source_url": None,
                "source_type": "公式機関発表",
                "resource_identifier": "宮内庁報道発表「皇太子同妃両殿下の第一女子の御誕生について」（2001年12月1日発表）",
                ...
                "notes": "公知の事実。宮内庁報道発表が一次資料だが、発表原文（verified_excerpt）を未取得のため手動確認が必要。",
            },
            {
                "fact_id": "F002",
                "claim": "御名「愛子」は『孟子』離婁章句下の一節に由来すると、命名の儀において公式に発表された",
                "status": cfg.FactStatus.CONFIRMED,
                "source_name": "宮内庁報道発表「命名の儀」（2001年12月7日）",
                "source_url": None,
                "source_type": "公式機関発表",
                "resource_identifier": "宮内庁報道発表「命名の儀」（2001年12月7日）/ 公開主体: 宮内庁",
                "verified_excerpt": None,
                "verified_date": "2001-12-07",
                "direct_or_contextual": "contextual",
                "usable_in_script": False,
                "manual_source_verification_required": True,
                "notes": "命名典拠の公式発表。報道各社が一斉報道した公知の事実だが、宮内庁発表資料の原文（verified_excerpt）を未取得のため手動確認が必要。",
            },
            {
                "fact_id": "F003",
                ...
                "usable_in_script": False,
                "manual_source_verification_required": True,
                "notes": "命名典拠の公式発表。御名と同一の古典出典であることは広く報道されたが、宮内庁発表資料の原文（verified_excerpt）を未取得のため手動確認が必要。",
            },
            {
                "fact_id": "F004",
                ...
                "usable_in_script": False,
                "manual_source_verification_required": True,
                "notes": "命名の経緯は公式発表されている公知の事実だが、宮内庁発表資料の原文（verified_excerpt）を未取得のため手動確認が必要。",
            },
            {
                "fact_id": "F005",
                ...
                "usable_in_script": False,
                "manual_source_verification_required": True,
                "notes": "宮内庁による公式発表日は事実だが、発表資料の原文（verified_excerpt）を未取得のため手動確認が必要。",
            },
            {
                "fact_id": "F006",
                ...
                "source_url": None,
                "source_type": "古典文献",
                "resource_identifier": "『孟子』離婁章句下（底本: 朱熹『四書章句集注』中華書局、1983年 / 小林勝人訳注『孟子』岩波文庫、1968年）",
                ...
                "notes": "古典原文の存在確認。上記底本および各種注釈書・学術データベース（CiNii等）で第三者が再確認可能。命名典拠であるかどうかはF002・F003で別途検証。",
            },
            {
                "fact_id": "F007",
                ...
                "usable_in_script": False,
                "manual_source_verification_required": True,
                "notes": "一般的に認められた慣例だが、単一の権威ある出典を特定できない。",
            },
        ],
        "sources": [
            {
